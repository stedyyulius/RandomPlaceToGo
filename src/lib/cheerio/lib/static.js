...
import { flatten as flattenOptions } from './options';
import { select } from 'cheerio-select-tmp';
 ...
 *
 */
export const load = async (content, options, isDocument) => {
 ...
 */
export const html = function (dom, options) {
 ...
 */
export const text = function (elems) {
  if (!elems) {
    elems = this.root();
  }
 ...
 */
export const parseHTML = function (data, context, keepScripts) {
  var parsed;
 ...
 */
export const contains = function (container, contained) {
 ...
 */
export const merge = function (arr1, arr2) {
